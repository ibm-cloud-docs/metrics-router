...
| Method | Supported |
|--------|-----------|
| Configuring {{site.data.keyword.metrics_router_full_notm}} | ![Checkmark icon](../../icons/checkmark-icon.svg "checkmark") |
| Configuring the {{site.data.keyword.mon_short}} service | ![Checkmark icon](../../icons/checkmark-icon.svg "checkmark") |
{: caption="Table 1. Methods to manage metrics in an {{site.data.keyword.cloud_notm}} account." caption-side="bottom"}



## Locations of service metrics
{: #platform-metrics-locations}

{{site.data.keyword.metrics_router_full_notm}} automatically generates metrics in all of the [supported regions](/docs/atracker?topic=atracker-regions#regions-atracker) so that you can track activity of the service in the account.

The following tables list the locations where the automatic collection of {{site.data.keyword.metrics_router_full_notm}} service metrics is enabled.

| Locations in Americas | Service metrics available |
|------------------------|--------------------------|
| `Dallas (us-south)` | ![Checkmark icon](../../icons/checkmark-icon.svg "checkmark") |
| `Washington DC (us-east)` | ![Checkmark icon](../../icons/checkmark-icon.svg "checkmark") |
{: caption="Table 2. The automatic collection of {{site.data.keyword.metrics_router_full_notm}} metrics in Americas locations" caption-side="bottom"}

| Locations in Asia Pacific | Service metrics available |
|---------------------------|--------------------------|
| `Sydney (au-syd)`         | ![Checkmark icon](../../icons/checkmark-icon.svg "checkmark") |
{: caption="Table 3. The automatic collection of {{site.data.keyword.metrics_router_full_notm}} metrics in Asia Pacific locations" caption-side="bottom"}
...
{: caption="Table 4. The automatic collection of {{site.data.keyword.metrics_router_full_notm}} metrics in Europe locations" caption-side="bottom"}
...
| Controlling what data is visible | [link](/docs/monitoring?topic=monitoring-platform_metrics_working#controlling-what-data-is-visible) |
...
{: caption="Table 5. More information about {{site.data.keyword.mon_short}} tasks" caption-side="bottom"}
...
- [Successful data points](#ibm_metrics_router_successful_data_points)
- [Target mode](#ibm_metrics_router_target_mode)
...
{: caption="Table 1. Total number of metrics successfully sent to the storage target" caption-side="top"}
...
| `Segment By`     | `ibm_ctype`,`ibm_location`, `ibm_scope`, `ibm_service_name`, `ibm_resource_type`, `ibm_resource_name`, `ibm_resource`, `ibm_metrics_router_target_type`  |
| `Frequency`      | `60 seconds`  |
{: caption="Table 2. The current target mode" caption-side="top"}
...
{: caption="Table 4. Other attributes" caption-side="top"}
...
| `Metrics Routing - Overview` | Use this dashboard to monitor {{site.data.keyword.metrics_router_full_notm}} data point processing and target modes. |
 {: caption="Table 5. Pre-defined dashboard templates" caption-side="top"}
