...
2. Get an IAM access token. For more information, see [Retrieving IAM access tokens](/docs/metrics_router?topic=metrics_router-retrieve-iam-token).

3. Identify the API endpoint in the region where you plan to configure or manage a target. For more information, see [Endpoints](/docs/metrics_router?topic=metrics_router-endpoints#endpoints_api).
