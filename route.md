...
2. Identify the API endpoint in the region where you plan to configure or manage a route. For more information, see [Endpoints](/docs/metrics_router?topic=metrics_router-endpoints#endpoints_api).
