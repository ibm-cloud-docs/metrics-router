...
Access to {{site.data.keyword.metrics_router_full}} configuration resources for users and applications in your account is controlled by {{site.data.keyword.cloud}} Identity and Access Management (IAM). Every user or application that accesses the {{site.data.keyword.metrics_router_full_notm}} service in your account must be assigned an access policy with an IAM role. Review the following roles, actions, and more to help determine the best way to assign access to {{site.data.keyword.metrics_router_full_notm}}.
{: shortdesc}
...
## Assigning access to {{site.data.keyword.metrics_router_full_notm}} in the console
{: #assign-access-ui}
{: ui}
...
## Assigning access to {{site.data.keyword.metrics_router_full_notm}} in the CLI
{: #assign-access-cli}
{: cli}
...
## Assigning access to {{site.data.keyword.metrics_router_full_notm}} by using the API
{: #assign-access-api}
{: api}
